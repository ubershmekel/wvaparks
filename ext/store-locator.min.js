...
*/
    ...
    storeLocator.FeatureSet.prototype.add = function(a) {
        a && (this.array_.push(a),
        this.hash_[a.getId()] = this.array_.length - 1)
    }
    ;
    storeLocator.FeatureSet.prototype.remove = function(a) {
        this.contains(a) && (this.array_[this.hash_[a.getId()]] = null ,
        delete this.hash_[a.getId()])
    }
    ;
    ...
    storeLocator.Panel.prototype.init_ = function() {
        ...
        this.settings_.locationSearch && (this.locationSearch_ = $('\x3cdiv class\x3d"location-search"\x3e\x3ch4\x3e' + this.settings_.locationSearchLabel + "\x3c/h4\x3e\x3cinput\x3e\x3c/div\x3e"),
        this.filter_.append(this.locationSearch_),
        "undefined" != typeof google.maps.places ? this.initAutocomplete_() : this.filter_.submit(function() {
        ...
        google.maps.event.addListener(this, "geocode", function(b) {
            if (b.geometry) {
                ...
                c.highlight(null );
                var d = c.getMap();
                b.geometry.viewport ? d.fitBounds(b.geometry.viewport) : (d.setCenter(b.geometry.location),
                d.setZoom(13));
                c.refreshView();
    ...
    storeLocator.Panel.prototype.selectedStore_changed = function() {
        ...
        if (b) {
            ...
            var c = a.get("view").getInfoWindow().getContent()
              , d = $("\x3ca/\x3e").text("Directions").attr("href", "https://www.google.com/maps?q=" + b.getLocation()).addClass("action").addClass("directions")
...
*/
    ...
    storeLocator.Store.prototype.generateFieldsHTML_ = function(a) {
        for (var b = [], c = 0, d = a.length; c < d; c++) {
            var e = a[c];
            this.props_[e] && (b.push('\x3cdiv class\x3d"'),
            b.push(e),
            b.push('"\x3e'),
    ...
    storeLocator.View.prototype.highlight = function(a, b) {
        ...
        a.getMarker() ? c.open(this.getMap(), a.getMarker()) : (c.setPosition(a.getLocation()),
        c.open(this.getMap())),
